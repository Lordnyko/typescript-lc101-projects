...
var kilometersToMars = 223000000;
...
var Spacecraft = /** @class */ (function () {
    ...
    Spacecraft.prototype.printDaysToLocation = function (location) {
        console.log(this.name + " would take " + this.getDaysToLocation(location.kilometersAway) + " dayss to get to " + location.name);
    };
    return Spacecraft;
}());
// Create an instance of the class here:
var spaceShuttle = new Spacecraft("Deez", 20500);
